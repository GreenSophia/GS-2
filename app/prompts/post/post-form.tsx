...
const SAMPLE_OUTPUT = `## スライド構成

【1枚目】表紙
見出し：野鳥、見つけました
本文：環境省の方々と、ソフィア会の先輩たちと。
ビジュアル指示：双眼鏡を覗く手元のイラスト、または実際の活動写真。

## キャプション
野鳥観察会、行ってきました。
環境省の方々、そしてソフィア会の先輩たちと一緒に、四谷の空の下で鳥探し。
      ...
      <div className="card">
        ...
        <div className="field" style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: 1, minWidth: 220 }}>
            <label>6. 読者にしてほしい行動 <span className="hint">空欄なら定番CTAに</span></label>
      ...
      <div className="card">
        ...
        {showSample && (
          <div style={{ marginTop: 20 }}>
            ...
            <div className="prompt-out" style={{ borderLeftColor: 'var(--gold)' }}>{SAMPLE_OUTPUT}</div>
          </div>
        )}
      </div>
